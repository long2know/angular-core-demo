...
import { AppComponent, AppRoutingModule, AppErrorHandler } from '.';
import { Route1Component, Route2Component, Route3Component, Route4Component } from './components';
...
import { HttpRequest, HttpXhrBackend, HttpClientJsonpModule } from '@angular/common/http';
...
@NgModule({
  imports: [
    ...
    FormsModule, ReactiveFormsModule, HttpClientJsonpModule, HttpClientModule, NgbModule, AppRoutingModule], // ToastyModule.forRoot()],
