import { Component, ViewEncapsulation, Input, Output, OnInit, ViewChild, EventEmitter, ChangeDetectionStrategy, ChangeDetectorRef, ElementRef, forwardRef, Renderer2 } from '@angular/core';
...
export class Multiselect implements OnInit, ControlValueAccessor {
  ...
  constructor(private _elRef: ElementRef, private _renderer: Renderer2, private _equalPipe: EqualPipe, private _changeDetectorRef: ChangeDetectorRef) {
  }
